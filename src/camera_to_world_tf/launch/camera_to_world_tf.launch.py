...
def generate_launch_description():
    ...
    urdf_path = os.path.join(get_package_share_directory(package_name), 'urdf', 'arm_with_camera.urdf')
    ...
    ld.add_action(node_camera_to_world_tf)
    return ld